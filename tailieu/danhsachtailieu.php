                ...
                <div class="text-center mt-3">
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-center">
                            ...
                            // Nút back
                            if ($trangHienTai > 1) {
                                echo '<li class="page-item"><a class="page-link" href="?'.$chon.'='.$selectedCategory.'&page=' . ($trangHienTai - 1) . '">Lùi</a></li>';
                            }
                            ...
                            if ($trangHienTai < $tongTrang) {
                                echo '<li class="page-item"><a class="page-link" href="?'.$chon.'='.$selectedCategory.'&page=' . ($trangHienTai + 1) . '">Tiếp</a></li>';
                            }
                            ?>
                        </ul>
                    </nav>
