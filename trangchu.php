...
<body>
    ...
    <div class="row" style="margin-left:0px; margin-right:0px;">
        <div id="carouselExampleCaptions" class="carousel slide ">
            ...
            <a href="#section1"  class="col-xl-3 btn btn-secondary " style="color:white"><div>Tài liệu mới nhất</div></a>
            <a href="#section2" class="col-xl-3 btn btn-secondary " style="color:white"><div>Bài viết mới nhất</div></a>
            <a href="#section3" class="col-xl-3 btn btn-secondary "style="color:white"><div>Tài liệu yêu thích</div></a>
            <a href="#section4"  class="col-xl-3 btn btn-secondary" style="color:white"><div>Bài viết yêu thích</div></a>
            </div>
        </div>
